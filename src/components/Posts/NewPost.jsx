...
export default function NewPost() {
  ...
  return (
    ...
    <>
      {mount ? (
        <div className="container text-gray-300 sm:max-w-[200px] sm:mx-auto md:max-w-[400px] md:mr-auto lg:max-w-full">
          ...
          <form className="flex w-full p-8 border-b-4 border-gray-300">
            <img
            ...
            <div className="flex flex-col justify-center space-x-2 space-y-2 w-full">
              ...
              <div className="flex">
                <button
                  onClick={PostNewData}
                  className="flex items-center h-8 px-3 text-xs rounded-sm bg-gray-900 hover:bg-gray-600"
                >
                  Post
                </button>
              </div>
