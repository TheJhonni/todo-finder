...
export default function SingleReply({
  ...
  return (
    <>
      {replyBody ? (
        <div className="flex justify-start w-fit mr-auto py-5 border-b border-gray-300">
          <img
          ...
          <div className="flex flex-col flex-grow ml-4">
            <div className="flex items-center">
              ...
              <span className="ml-1 text-blue-700">@{commentAuthor}</span>
        ...
        <span className="mt-3">No reply yet</span>
      )}

      {/* {input && <InputSendReply replies={replies} id={replies.id} />} */}
    </>
  );
}
