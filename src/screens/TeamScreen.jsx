        ...
        <div className="w-full h-full bg-gray-300">
          ...
          <div className="max-w-screen-xl my-5 px-4 mx-auto md:px-8">
           ...
           bg-transparent shadow-sm w-[100px] h-[50px] cursor-pointer"
              ...
              <span className="ml-5">Go back</span>
            </h1>
            <div className="md:mb-16">
              <p className="max-w-screen-md mx-auto text-center mt-10 text-gray-500 md:text-lg">
                ...
                better outcomes. People are more likely to take calculated risks
                that lead to innovation if they have the support of a team
                behind them. Working in a team encourages personal growth,
